  ...
  return {
    ...
    ar: {
      ...
      admin: {
        ...
        searchUsers: 'البحث في المستخدمين بالاسم أو البريد الإلكتروني أو العلامة التجارية...',
        ...
        category: 'الفئة',
        location: 'الموقع',
        adjustCredits: 'تعديل الرصيد',
        deleteUser: 'حذف المستخدم',
        confirmDelete: 'هل أنت متأكد؟',
        deleteUserConfirmation: 'سيؤدي هذا إلى حذف المستخدم وجميع بياناته نهائياً. لا يمكن التراجع عن هذا الإجراء.',
        enterAmount: 'أدخل المبلغ',
        addCredits: 'إضافة',
        subtractCredits: 'خصم',
        creditsUpdated: 'تم تحديث الرصيد',
        creditsUpdatedDescription: 'تم تحديث رصيد المستخدم بنجاح.',
        creditUpdateFailed: 'فشل في تحديث الرصيد',
        fetchUsersFailed: 'فشل في جلب المستخدمين',
        userDeleted: 'تم حذف المستخدم',
        userDeletedDescription: 'تم حذف المستخدم وجميع البيانات المرتبطة به.',
        userDeleteFailed: 'فشل في حذف المستخدم',
        noUsersFound: 'لم يتم العثور على مستخدمين',
        totalUsers: 'إجمالي المستخدمين',
        totalUsersDesc: 'جميع المستخدمين المسجلين',
        activeUsers: 'المستخدمون النشطون',
        activeUsersDesc: 'المستخدمون المتصلون بحسابات التواصل الاجتماعي',
        scheduledPosts: 'المنشورات المجدولة',
        scheduledPostsDesc: 'إجمالي المنشورات المجدولة',
        totalProducts: 'إجمالي المنتجات',
        totalProductsDesc: 'جميع المنتجات المرفوعة',
