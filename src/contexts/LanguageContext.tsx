...
const getTranslations = () => {
  return {
    ...
    ar: {
      ...
      'hero.subtitle': 'الذكاء الاصطناعي يشيل عنك هم التسويق والانتشار وأنت ركز على شغفك',
      'hero.description': 'ارفع منتجاتك، واحصل على محتوى تسويقي ذكي وجدول منشوراتك تلقائيًا على مواقع التواصل — بسهولة، وبدون صداع المحتوى.',
